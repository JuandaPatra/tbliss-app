            ...
            <div style="display:inline-block">
                <div style="padding-left:8px;padding-right:8px">
                    ...
                    <h1 style="color:#000;font-size:20px;font-weight: 100;margin:0;margin-bottom:5px;">
                        Terimakasih telah memilih kami sebagai partner perjalananmu.
                    </h1>
                    <h1 style="color:#000;font-size:20px;font-weight: 100;margin:0;">
                        Selangkah lagi kamu dapat menuju destinasi idamanmu <br> silahkan lakukan pembayaranmu selanjutnya sebelum jatuh tempo {{$duedate}}. <br>
                    </h1>
                    <p>Silahkan hubungi admin melalui Whatsapp 087260038649 untuk metode pembayaran</p>
                    <p>Jika kamu sudah membayar ,abaikan saja email ini</p>
            ...
            <table id="m_579706666474593286attendeeInfoTable" cellspacing="0" cellpadding="0" border="0" style="color:#5b5b5b;margin-bottom:10px;padding:2px 0px 0;width:100%">
                <tbody>
                    ...
                    <tr style="height:30px">
                        ...
                        <td style="padding:10px" width="30" height="21">:</td>
                        <td style="padding:10px" width="293" height="21" align="left">Menunggu pembayaran</td>
                    </tr>
                </tbody>
            </table>
        </div>
