...
<div class="flex items-center h-[650px] px-4 py-2 bg-white lg:justify-center">
    ...
    <div class="p-5 bg-white md:flex-1">
      <form action="{{route('signup.store')}}" method="post" class="flex flex-col space-y-5">
        ...
        <div class="relative mb-6">
          ...
          <input type="password" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Confirm password" name="confirmPassword">
        </div>
