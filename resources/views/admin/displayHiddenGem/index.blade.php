...
<div class="">
    <h5 class="card-header">Choose Hidden Gem</h5>
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                        ...
                        <div class="table-responsive text-nowrap" style="height:500px">
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    @forelse ($listHiddenGems as $row)
                                    <tr>
                                        <td><img src="{{ $row->hidden_gem->image_desktop }}" alt="" style="height: 70px;"></td>
                                        <td><strong>{{ $row->hidden_gem->title }}</strong></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form action="{{ route('choose-hidden-gem.destroy',$row->hidden_gem_id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                ...
                <div class="col-4">
                    <div class="card mb-4 px-3 pb-3" id="includes-add">
                        <h5 class="card-header">Choose Hidden Gem displayed</h5>
                        <form action="{{  route('choose-hidden-gem.store') }}" method="POST">
                            @csrf
                            {{--
                                <input type="hidden" name="trip_cat_id" class="form-control" value="{{ $slug }}">
                            --}}
                            <div class="mb-3">
                                <select id="select_post_status" name="hidden_gem_id" class="form-select @error('status') is-invalid @enderror">
                    ...
                    <div class="card mb-4 px-3 pb-3 d-none" id="includes-edit">
                        <h5 class="card-header">Edit Hidden Gem </h5>
                        <form id="include-update-form" method="POST" action="">
                            @csrf
                            @method('PUT')
