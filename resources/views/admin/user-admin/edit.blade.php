...
<div class="row">
    <div class="col-md-11">
        <form action="{{  route('user-admin.update', ['user_admin'=>$user]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="input_post_title" name="email" type="email" placeholder="" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $user->email) }}" />
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        <label for="input_post_title" class="form-label">Old Password</label>
                        <input id="input_post_title" name="oldPassword" type="password" placeholder="" class="form-control @error('password') is-invalid @enderror" name="oldPassword" value="{{ old('oldPassword') }}" />
                        @error('oldPassword')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        <label for="input_post_title" class="form-label">New Password</label>
                    ...
                    <div class="mb-3">
                        <label for="input_post_title" class="form-label">Confirm New Password</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="select_post_status" name="role" class="form-select @error('role') is-invalid @enderror">
                            ...
                            <option value="{{ $value }}" {{ old('roles',  $roleOld) == $value ? "selected" : null }}> {{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
