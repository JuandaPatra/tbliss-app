                ...
                <div class="modal fade" id="modalCenter" tabindex="-1" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{  route('product.testimoniAdd',[$id]) }}" method="POST">
                                @csrf
                                <input type="hidden" value="{{$id}}" class="trips_value">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('product.editTestimoniTrip',['product'=>$row]) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                <form action="{{ route('product.destroyTestimoniTrip',['product'=>$row]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
