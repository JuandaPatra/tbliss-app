...
<div class="row">
    <div class="col-md-11">
        <form action="{{  route('testimoni-trip.update', ['testimoni_trip'=>$datas->id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input id="input_post_title" name="name" type="text" placeholder="" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $datas->name) }}" />
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input id="input_post_pdf" name="image" value="{{ old('image', $datas->image) }}" type="text" class="form-control" placeholder="" readonly />
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
